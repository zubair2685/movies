...
API_ID = int(environ.get('API_ID', '2533'))
API_HASH = environ.get('API_HASH', '61cc2f9591d90bd858cc0fdfdd')
BOT_TOKEN = environ.get('BOT_TOKEN', '759:AAH4BUJLWTLXCqmEshQJyt2g')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-10020227'))
