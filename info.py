...
API_ID = int(environ.get('API_ID', '23'))
API_HASH = environ.get('API_HASH', '591d901dfdd')
BOT_TOKEN = environ.get('BOT_TOKEN', '7759:AAH4BUJLyt2a0JMEO89g')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1336').split()]
